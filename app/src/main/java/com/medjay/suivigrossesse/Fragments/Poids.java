...
public class Poids extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_poids, container, false);
    ...
    public void onAttach(Context context) {
        ...
        call=service.getMesure(tokenManager.getToken().getToken(),"Poids");
        ...
        call.enqueue(new Callback<List<Donnee>>() {
            ...
            public void onResponse(Call<List<Donnee>> call, Response<List<Donnee>> response) {
                if(response.code()==200){
                    ...
                    LimitLine upper_limit=new LimitLine(24.9f,"Surpoids");
                    upper_limit.setLineWidth(4f);
                    upper_limit.enableDashedLine(10f,10f,0f);
                    upper_limit.setLabelPosition(LimitLine.LimitLabelPosition.RIGHT_TOP);
                    upper_limit.setTextSize(15f);

                    LimitLine lower_limit=new LimitLine(18.5f,"Insuffisance pondérale");
