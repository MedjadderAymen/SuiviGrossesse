...
public class Tenssion extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_tenssion, container, false);
    ...
    public void onAttach(Context context) {
        ...
        call=service.getMesure(tokenManager.getToken().getToken(),"Tenssion");
        ...
        call.enqueue(new Callback<List<Donnee>>() {
            ...
            public void onResponse(Call<List<Donnee>> call, Response<List<Donnee>> response) {
                ...
                if(response.code()==200){
                    ...
                    LimitLine upper_limit=new LimitLine(14.5f,"Hyper-tenssion");
                    {upper_limit.setLineWidth(4f);
                    upper_limit.enableDashedLine(10f,10f,0f);
                    upper_limit.setLabelPosition(LimitLine.LimitLabelPosition.RIGHT_TOP);
                    upper_limit.setTextSize(15f);}
                    LimitLine lower_limit=new LimitLine(9f,"Hypo-tenssion");
                    ...
                    LineDataSet dataSet = new LineDataSet(entries, "Tenssion"); // add entries to dataset
