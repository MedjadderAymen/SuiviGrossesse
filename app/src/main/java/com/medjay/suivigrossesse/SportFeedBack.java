...
public class SportFeedBack extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sport_feed_back);
        ...
        spinner.setOnItemSelectedListener(new MaterialSpinner.OnItemSelectedListener<String>() {
            ...
            @Override public void onItemSelected(MaterialSpinner view, int position, long id, String item) {
                ...
                switch (item){
                    case "Difficile" : mood.setImageResource(R.drawable.ic_mood_bad_black_24dp); break;
                    case "Moyen" : mood.setImageResource(R.drawable.ic_sentiment_neutral_black_24dp); break;
                    case "Facile" : mood.setImageResource(R.drawable.ic_mood_black_24dp); break;
                }
                reaction=item;
            }
        });
    ...
    public void submit(View view){
        ...
        call=service.setFeedBackSport(tokenManager.getToken().getToken(),comment.getText().toString(),reaction);
